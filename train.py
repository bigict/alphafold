...
from alphafold.train.train_config import train_config
...
from alphafold.train.data_system import DataSystem, GetBatchProcess
from alphafold.train.utils import get_queue_item
from alphafold.train.trainer import Trainer
...
def train(train_config):
  ...
  model_config.update_from_flattened_dict(train_config.model)
